...
from f1_coach.infrastructure.f125_udp.telemetry_mapper import AssistConfig, CarSetupFields, SessionConditions
...
from f1_coach.infrastructure.storage.f125_parquet_writer import write_car_status, write_telemetry
from f1_coach.infrastructure.f125_udp.telemetry_mapper import AssistConfig, SessionConditions
from f1_coach.infrastructure.storage.f125_parquet_writer import (
    write_car_status,
    write_positions,
    write_telemetry,
)
